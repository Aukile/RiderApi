...
public final class RegisterAssist {
    ...
    public static String getRegisterName(Class<?> type) {
        ...
        else if (MapCodec.class.isAssignableFrom(type)) return "worldgen/biome_source";
        else if (Block.class.isAssignableFrom(type)) return "block";
        else if (MapCodec.class.isAssignableFrom(type)) return "block_type";
        ...
        else if (WolfVariant.class.isAssignableFrom(type)) return "wolf_variant";
        else if (MapCodec.class.isAssignableFrom(type)) return "worldgen/chunk_generator";
        ...
        else if (MapCodec.class.isAssignableFrom(type)) return "worldgen/density_function_type";
        else if (MapCodec.class.isAssignableFrom(type)) return "enchantment_entity_effect_type";
        else if (MapCodec.class.isAssignableFrom(type)) return "enchantment_level_based_value_type";
        else if (MapCodec.class.isAssignableFrom(type)) return "enchantment_location_based_effect_type";
        else if (MapCodec.class.isAssignableFrom(type)) return "enchantment_provider_type";
        else if (MapCodec.class.isAssignableFrom(type)) return "enchantment_value_effect_type";
        ...
        else if (JukeboxSong.class.isAssignableFrom(type)) return "jukebox_song";
        ...
        else if (MapCodec.class.isAssignableFrom(type)) return "worldgen/material_condition";
        else if (MapCodec.class.isAssignableFrom(type)) return "worldgen/material_rule";
        ...
        else if (MapCodec.class.isAssignableFrom(type)) return "worldgen/pool_alias_binding";
        ...
        else if (DecoratedPotPattern.class.isAssignableFrom(type)) return "decorated_pot_pattern";
        else if (NumberFormatType.class.isAssignableFrom(type)) return "number_format_type";
        else if (ArmorMaterial.class.isAssignableFrom(type)) return "armor_material";
        else if (DataComponentType.class.isAssignableFrom(type)) return "data_component_type";
        else if (EntitySubPredicate.class.isAssignableFrom(type)) return "entity_sub_predicate_type";
        else if (ItemSubPredicate.class.isAssignableFrom(type)) return "item_sub_predicate_type";
        else if (MapDecorationType.class.isAssignableFrom(type)) return "map_decoration_type";
        else if (DataComponentType.class.isAssignableFrom(type)) return "enchantment_effect_component_type";
        ...
        else if (EnchantmentProvider.class.isAssignableFrom(type)) return "enchantment_provider";
        ...
        else if (CriterionTrigger.class.isAssignableFrom(type)) return "trigger_type";
        ...
        else if (LootTable.class.isAssignableFrom(type)) return "loot_table";
        else if (LootItemFunction.class.isAssignableFrom(type)) return "item_modifier";
        else if (LootItemCondition.class.isAssignableFrom(type)) return "predicate";
        else if (Advancement.class.isAssignableFrom(type)) return "advancement";
        else if (Recipe.class.isAssignableFrom(type)) return "recipe";
